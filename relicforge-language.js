(() => {
  ...
  const replacements = [
    ...
    [/release candidate/gi, 'release'],
    [/Unaudited/g, 'Not independently audited'],
    [/unaudited/g, 'not independently audited'],
    [/Sepolia preproduction infrastructure/gi, 'verified deployment infrastructure'],
    [/preproduction creator workflow/gi, 'creator workflow'],
    [/NETWORK-AWARE PREPARATION/g, 'NETWORK-AWARE LAUNCH'],
    [/TESTNET MARKETPLACE VIEWER/g, 'COLLECTION VIEWER'],
    [/TEST R12-v2 RESULT/g, 'POST-LAUNCH TOOLS'],
    [/test controls/gi, 'post-launch tools'],
    [/Sepolia test build/gi, 'current build'],
    [/test deployment/gi, 'deployment'],
    [/TEST infrastructure/g, 'infrastructure'],
    [/test NFT/gi, 'NFT'],
    [/testnet/gi, 'development network'],
  ];
