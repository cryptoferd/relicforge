# RelicForge V11.0.2 — Railway + Alchemy Setup
...
- A Railway account.
- An Alchemy account. V11.0.2 uses one private API key with a built-in EVM endpoint registry instead of one Railway variable per chain.
...
V11.0.2 no longer stores a full Alchemy URL per network. Add **one private variable** to the Railway API service:
