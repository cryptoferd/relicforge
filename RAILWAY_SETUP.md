# RelicForge V11.1.4 — Railway + Alchemy Setup
...
- A Railway account.
- An Alchemy account. V11.1.4 uses one private API key with a built-in EVM endpoint registry instead of one Railway variable per chain.
...
V11.1.4 no longer stores a full Alchemy URL per network. Add **one private variable** to the Railway API service:
