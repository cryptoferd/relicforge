...
app.get('/health', async () => {
  ...
  return { ok: true, service: 'relicforge-cloud-api', version: '11.1.2', alchemy: { configured: Boolean(process.env.ALCHEMY_API_KEY), catalogedEvmNetworks: ALCHEMY_EVM_NETWORKS.length } };
});
