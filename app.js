(() => {
  ...
  async function restoreStudioProjectSnapshot(snapshot) {
    ...
    const compilerNeedsRebuild = !!savedCompilerReport && savedCompilerReport.compilerVersion !== '10.8.5';
    ...
    updateLaunchSummary();
    if (compilerNeedsRebuild) showStatus(`Project restored. Rebuild the collection in Step 4 with the V10.8.5 rarity compiler before forging.`, 'warn');
  ...
  window.dispatchEvent(new CustomEvent('relicforge:studio-bridge-ready', { detail: { version: '10.8.5' } }));
